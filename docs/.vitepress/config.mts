...
export default defineConfig({
  ...
  base: '/VersePc_docs/',
  title: "VersePc Docs",
  description: "versePc 启动器的文档与教程站",
  themeConfig: {
      ...
      '/main/': [
        {
          ...
          link: '/main/start/',
          items: [
            { text: '1. 下载和安装', link: '/main/start/install' },
            { text: '2. 基本功能', link: '/main/start/basic_functions' },
            {
              text: '3. 多人游戏',
              link: '/main/multiplayer/',
              items: [
                { text: '3.1 陶瓦联机', link: '/main/multiplayer/terracotta' },
    ...
    socialLinks: [
      ...
      { 
        icon: {
          svg: `
<svg width="800px" height="800px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"><defs></defs>
    ...
    footer: {
      message: '本文档站由 Redersha 制作。基于 CC BY-SA 4.0 许可发布。versePc 和本文档站与 Microsoft / Mojang 无关。',
      copyright: '（versePc）版权所有 © 2026 - 至今 豆杰'
    },
    docFooter: {
      prev: '上一页',
      next: '下一页'
